module "cw_alerts" {
  ...
  alerts = concat(
    [
      {
        name    = "DB: High CPU Utilization Alert on ${local.alarms_resource_label} ${var.identifier}"
      ...
      {
        name    = "DB: Low Freeable Memory Alert on ${local.alarms_resource_label} ${var.identifier}"
      ...
      {
        name    = "DB: High Read Latency Detected on ${local.alarms_resource_label} ${var.identifier}"
      ...
      {
        name    = "DB: High Write Latency Detected on ${local.alarms_resource_label} ${var.identifier}"
      ...
      {
        name    = "DB: High Database Connection Usage on ${local.alarms_resource_label} ${var.identifier}"
      ...
      {
        name    = "DB: High WRITE IOPS Utilization Alert on ${local.alarms_resource_label} ${var.identifier}"
    ...
    local.is_aurora ? [] : [
      {
        ...
        filters = { DBInstanceIdentifier = var.identifier }
