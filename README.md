...
|------|-------------|------|---------|:--------:|
| <a name="input_alarms"></a> [alarms](#input\_alarms) | n/a | <pre>object({<br>    enabled                   = optional(bool, true)<br>    sns_topic                 = string<br>    alarms-with-custom-values = optional(any, {})<br>  })</pre> | n/a | yes |
