...
| <a name="input_storage_type"></a> [storage\_type](#input\_storage\_type) | One of 'standard' (magnetic), 'gp2' (general purpose SSD), gp3, or 'io2' (provisioned IOPS SSD). The default is 'io2' if iops is specified, 'gp2' if not | `string` | `null` | no |
